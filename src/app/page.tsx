...
const values = [
  {
    category: "People",
    description:
      "To treat all with respect as we ourselves would like to be treated.",
    icon: UsersIcon,
  },
  {
    category: "Portfolio",
    description:
      "Provide our customers with a variety of products to suit their needs.",
    icon: BriefcaseIcon,
  },
  {
    category: "Planet",
    description:
      "Be responsible citizens that make a difference by helping build and support sustainable communities.",
    icon: GlobeAltIcon,
  },
  {
    category: "Productivity",
    description: "Aim to provide efficient services to our esteemed customers.",
    icon: ClockIcon,
  },
];
// const blogPosts = [
...
export default function Home() {
  ...
  return (
    <main>
      <div className="bg-gray-800 pt-10 sm:pt-16 lg:overflow-hidden lg:pb-14 lg:pt-8">
        <div className="mx-auto max-w-7xl lg:px-8">
          <div className="lg:grid lg:grid-cols-2 lg:gap-8">
            ...
            <div className="-mb-16 mt-12 sm:-mb-48 lg:relative lg:m-0 hidden lg:block">
              <div className="mx-auto max-w-[300px] px-6 sm:max-w-2xl lg:max-w-[300px] lg:px-0 overflow-hidden">
                {/* Illustration taken from Lucid Illustrations: https://lucid.pixsellz.io/ */}
                <img
                  className="w-auto rounded-lg lg:absolute lg:inset-y-0 lg:left-0 lg:h-full lg:w-auto lg:max-w-none"
      ...
      <div className="relative bg-white py-16 sm:py-24 lg:py-32">
        <div className="mx-auto max-w-md px-6 text-center sm:max-w-3xl lg:max-w-7xl lg:px-8">
          ...
          <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
            Lending a Hand, Transforming Lives
          </p>
          <p className="mx-auto mt-5 max-w-prose text-xl text-gray-500">
            {`we understand that financial stability is the cornerstone of every
            dream. That's why we're committed to providing accessible and
            tailored loan solutions designed to empower individuals and
            businesses across Africa. Explore our values below to discover how
            we're redefining lending with integrity, transparency, and
            unwavering support for your aspirations.`}
          </p>
          <div className="mt-12">
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              {values.map((feature) => (
                <div key={feature.category} className="pt-6">
