...
const CheckOffLoans = () => {
  return (
    <main className="flex justify-center align-middle items-center min-w-screen">
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 items-start gap-x-8 gap-y-16 sm:gap-y-24 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            <div className="lg:pr-4">
              <div className="relative overflow-hidden rounded-3xl bg-gray-900 px-6 pb-9 pt-64 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10">
                ...
                >
                  <div
                    className="aspect-[1097/845] w-[68.5625rem] bg-gradient-to-tr from-primary to-[#776fff] opacity-30"
                    style={{
                      clipPath:
                ...
                <figure className="relative isolate">
                  ...
                  <blockquote className="mt-6 text-xl font-semibold leading-8 text-white">
                    <p>
                      “Here is some random wise words that i said that one time”
                    </p>
                  </blockquote>
            ...
            <div>
              ...
              <div className="mt-10 flex">
                <a
                  href="/apply-loan"
                  className="text-base hover:text-primary transition-all ease-in-out font-semibold leading-7 text-indigo-600"
                >
